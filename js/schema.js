...
const findOrCreate = require("mongoose-findorcreate"); // Para poder usar la funcion findOrCreate que usan las estrategias de passport oauth
      passportLocalMongoose = require("passport-local-mongoose"); // Para usar este paquete necesitamos instalar tambien por npm el paquete "passport-local" aunque no lo requiramos
